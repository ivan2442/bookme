...
<section id="booking" class="py-12 space-y-6 hidden max-w-full overflow-x-hidden">
    ...
    <div class="grid lg:grid-cols-[2fr,1.2fr] gap-6">
        <form class="relative p-4 sm:p-6 bg-white/90 border border-slate-100 rounded-2xl shadow-sm space-y-4 max-w-full overflow-hidden" data-booking-form>
            <!-- Loading Overlay -->
            <div id="booking-loading" class="absolute inset-0 z-20 bg-white/95 backdrop-blur-sm flex items-center justify-center rounded-2xl hidden">
