...
<section class="pt-12 pb-6 space-y-6">
    ...
    <div class="grid lg:grid-cols-[1.1fr,1fr] gap-4">
        <div class="card space-y-4">
            <h2 class="font-semibold text-lg text-slate-900">Pridať zamestnanca</h2>
            <form method="POST" action="{{ route('admin.employees.store') }}" class="space-y-3">
                @csrf
                <div>
