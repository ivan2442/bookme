                    ...
                    @forelse($appointments as $appointment)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <form method="POST" action="{{ route('owner.appointments.delete', $appointment) }}" onsubmit="return confirmDelete(event, '{{ __('Are you sure you want to delete this appointment?') }}')">
                                    @csrf @method('DELETE')
