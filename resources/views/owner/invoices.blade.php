...
<div class="space-y-6">
    <div class="flex items-center justify-between gap-3 mb-2">
        <div>
            <h1 class="font-display text-3xl text-slate-900">Faktúry za systém</h1>
            <p class="text-sm text-slate-500">Prehľad faktúr za využívanie rezervačného systému BookMe.</p>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('owner.invoices.preview', $invoice) }}" target="_blank" class="p-2 rounded-lg bg-slate-100 text-slate-600 hover:bg-emerald-50 hover:text-emerald-600 transition shadow-sm" title="Zobraziť faktúru">
